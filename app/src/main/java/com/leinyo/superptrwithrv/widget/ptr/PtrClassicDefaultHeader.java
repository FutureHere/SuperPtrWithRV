...
public class PtrClassicDefaultHeader extends FrameLayout implements PtrUIHandler {
    ...
    protected void initViews(AttributeSet attrs) {
        ...
        buildAnimation();
        View header = LayoutInflater.from(getContext()).inflate(R.layout.header_ptr_view, this);
    ...
    public void onUIRefreshPrepare(PtrFrameLayout frame) {
        ...
        if (frame.isPullToRefresh()) {
            mTitleTextView.setText(getResources().getString(R.string.pull_to_refresh_pull_label));
        } else {
            mTitleTextView.setText(getResources().getString(R.string.pull_to_refresh_pull_label));
        }
    }
    ...
    public void onUIRefreshBegin(PtrFrameLayout frame) {
        ...
        mTitleTextView.setVisibility(VISIBLE);
        mTitleTextView.setText(R.string.pull_to_refresh_refreshing_label);
    ...
    private void crossRotateLineFromTopUnderTouch(PtrFrameLayout frame) {
        if (!frame.isPullToRefresh()) {
            mTitleTextView.setVisibility(VISIBLE);
            mTitleTextView.setText(R.string.pull_to_refresh_release_label);
        }
    }

...
public class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private void setUp(final double diameter) {
        final int shadowYOffset = CommonUtils.dpTopx(mContext, Y_OFFSET);
        final int shadowXOffset = CommonUtils.dpTopx(mContext, X_OFFSET);
        int mShadowRadius = CommonUtils.dpTopx(mContext, SHADOW_RADIUS);
